...
wire div_clk_out;
reg temp_pwm;
reg polling_complete_flag_temp=0;
wire switch_reset_temp;
reg [15:0] number_of_samples_logic_high_temp =0;
reg [1:0] sw_rst=0;  
reg [15:0] number_of_samples_temp=0;
    ...
    if (rst | switch_reset_temp) begin
        ...
        if (~sw[3] & ~sw[2] )begin  
            adjusted_counter1<=adjusted_counter1+1;
             if (temp_pwm)begin
            number_of_samples_logic_high_temp<=number_of_samples_logic_high_temp+1;
            end
            number_of_samples_temp <= number_of_samples_temp+1;
...
assign pwm=temp_pwm;
//assign polling_complete_flag_g = 0;
assign polling_complete_flag_g = polling_complete_flag_temp;
assign width_sig = width;
assign number_of_samples_logic_high = number_of_samples_logic_high_temp;
//assign number_of_samples_logic_high = 0;
assign number_of_samples= number_of_samples_temp;
//assign number_of_samples= 0;
