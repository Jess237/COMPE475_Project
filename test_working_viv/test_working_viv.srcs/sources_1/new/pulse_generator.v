...
reg [DEFAULT_BITWIDTH+7:0] adjusted_counter2; 
reg [DEFAULT_BITWIDTH+10:0] adjusted_counter3; 
...
always @(posedge clk)begin
    if (rst) begin
        ...
        if (sw[2])adjusted_counter1<=adjusted_counter2+1;
        if (sw[3])adjusted_counter1<=adjusted_counter3+1;
        if (~sw[3] and ~sw[2])adjusted_counter1<=adjusted_counter1+1;
        ...
        4'b0101: begin
            ...
            adjusted_counter2 = 5'd31|{zero,3'b0}; // 5+3=8 max bit width
            end
        4'b0111: begin
        ...
        4'b1000: begin
            adjusted_counter1 = 5'd31|{zero,3'b0}; /
            width = 5'd0;
            end
        4'b1001: begin
            width = 12'd1024; //25%
            adjusted_counter = 5'd4095|{zero,7'b0}; //12-5=7
            end
        4'b1010: begin
            width = 12'd2048; // 50%
            adjusted_counter = 5'd4095|{zero,7'b0}; //12-5=7
        ...
        4'b1011: begin
            width = 12'd3072; //75%
             adjusted_counter = 12'd4095|{zero,7'b0}; //12-5=7
            end
        4'b1100:width=15'd0;
        4'b1101:begin
            width = 15'd8192; //25%
            adjusted_counter= 15'd32767|{zero,10'b0};
        end
        4'b1110: begin
            width = 15'd16384; // 50%
            adjusted_counter=15'd32767|{zero,10'b0};
        ...
        4'b1111: begin
            width = 15'd12288;
            adjusted_counter=15'd31|{zero,10'b0};
        end
		default : begin 
			width = 5'd0;
		    end
