...
always @(posedge clk)begin
    if (rst) begin
        ...
        4'b0101: begin
            ...
            adjusted_counter = {zero,3'b0}; // 5+3=8 max bit width
            end
        4'b0111: begin
        ...
        4'b1001: begin
            width = 12'd1024; //25%
            adjusted_counter = {zero,7'b0}; //12-5=7
            end
        4'b1010: begin
            width = 12'd2048; // 50%
            adjusted_counter = {zero,7'b0}; //12-5=7
